                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Reparar una Tarjeta de Red</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b666" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM red WHERE serial = '$serial' and estado<>'disponible'  and estado<>'no disponible'");
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-4'>
                         ...
                         <h3><strong>Tarjeta de Red $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                             ...
                             <br>
                                 <form method='post' action='app_server/reparaciones/buscar/phpbuscar/phpbuscarred.php'>
