                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar un Disco Duro</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b4" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM discoduro WHERE serial = '$serial' ");
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-6'>
                         ...
                         <h3><strong> Disco Duro: $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Capacidad: </strong><span class='text-primary'><strong>$capacidad</strong></span><h4></li> 
                                <li><h4><strong>Tipo: </strong><span class='text-primary'><strong>$tipo</strong></span><h4></li> 
                                <li><h4><strong>Cache: </strong><span class='text-primary'><strong>$cache</strong></span><h4></li> 
                                <li><h4><strong>Revoluciones: </strong><span class='text-primary'><strong>$rpm</strong></span><h4></li> 
                                <li><h4><strong>Año: </strong><span class='text-primary'><strong>$ano</strong></span><h4></li> 
                                <li><h4><strong>Serial: </strong><span class='text-primary'><strong>$modelo</strong></span><h4></li>  
