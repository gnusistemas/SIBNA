                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar un UPS</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b16" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM ups WHERE serial = '$serial' ");
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-6'>
                         ...
                         <h3><strong>UPS: $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Voltaje de Entrada: </strong><span class='text-primary'><strong>$entrada</strong></span><h4></li> 
                                <li><h4><strong>Voltaje de Salida: </strong><span class='text-primary'><strong>$salida</strong></span><h4></li> 
