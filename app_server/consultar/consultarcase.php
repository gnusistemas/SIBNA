                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar un Case</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b7" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM cas WHERE serial = '$serial' ");
                     ...
                     <div class='col-xs-6'>
                         ...
                         <h3><strong>Case: $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Dimensiones: </strong><span class='text-primary'><strong>$dimensiones</strong></span><h4></li> 
