                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar Cornetas</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b18" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM cornetas WHERE serial = '$serial'");
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-6'>
                         ...
                         <h3><strong>Cornetas: $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Cornetas: </strong><span class='text-primary'><strong>$sub</strong></span><h4></li> 
                                <li><h4><strong>Potencia: </strong><span class='text-primary'><strong>$potencia</strong></span><h4></li> 
                                <li><h4><strong>Color: </strong><span class='text-primary'><strong>$color</strong></span><h4></li> 
                                <li><h4><strong>Frecuencia: </strong><span class='text-primary'><strong>$frecuencia</strong></span><h4></li> 
