                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar un Monitor</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b10" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM monitor WHERE serial = '$serial' ");
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-6'>
                         ...
                         <h3><strong>Monitor $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Dimensiones: </strong><span class='text-primary'><strong>$dimension</strong></span><h4></li> 
                                <li><h4><strong>Tipo: </strong><span class='text-primary'><strong>$tipo</strong></span><h4></li> 
                                <li><h4><strong>Voltaje: </strong><span class='text-primary'><strong>$voltaje</strong></span><h4></li> 
