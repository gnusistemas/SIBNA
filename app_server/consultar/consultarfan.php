                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="card-header">
                                    <div class="card-title">
                                        <div class="title" ><p class="text-center">Consultar un FanCooler</p></div>
                                    </div>
                            </div>
                           <div class="card-body">
                            
                                <h5><strong>Introduzca el Codigo de Barra</strong></h5>
                                  <form  method="post" action="?page=b3" class="form-inline"> 
       ...
       <?php 
             ...
             $result = pg_query("SELECT * FROM fan WHERE serial = '$serial' ");

             while ($row=pg_fetch_assoc($result)) {
                $n++;
                $fabricante=$row['fabricante'];
        $modelo=$row['modelo'];
        $socketsoportado=$row['socketsoportado'];
        $rpm=$row['rpm'];
        $ano=$row['ano'];
        $serial2=$row['serial2'];
                 ...
                 <div class='container'> 
                   <div class='row'>
                     <div class='col-xs-6'>
                         ...
                         <h3><strong> FanCooler $serial</strong><h4></h3><br>
                            <ul class='list-unstyled'>
                                ...
                                <li><h4><strong>Socket: </strong><span class='text-primary'><strong> $socketsoportado </strong></span><h4></li>
