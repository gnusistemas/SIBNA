<?php 
    ...
    $sql = pg_query("select * from teclado where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Teclado(s) Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['color'].'</a></td>
                                                             <td width=200px><center>'.$info['puerto'].'</center></th>
                                                             <td width=200px><center>'.$info['idioma'].'</center></a></td>
