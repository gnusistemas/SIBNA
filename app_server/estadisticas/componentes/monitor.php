<?php 
    ...
    $sql = pg_query("select * from monitor where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Monitor(es) Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['dimension'].'</center></th>
