<?php 
    ...
    $sql = pg_query("select * from cd where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Unidad(es) de CD(s) Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['lector'].'</a></td>
                                                             <td width=200px><center>'.$info['velocidad'].'</center></th>
                                                             <td width=200px><center>'.$info['puerto'].'</center></a></td>
