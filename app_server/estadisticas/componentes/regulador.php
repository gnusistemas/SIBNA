<?php 
    ...
    $sql = pg_query("select * from regulador where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Reguladore(s) Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['watts'].'</a></td>
                                                             <td width=200px><center>'.$info['fan'].'</center></th>
                                                             <td width=200px><center>'.$info['salida'].'</center></a></td>
