<?php 
    ...
    $sql = pg_query("select * from ups where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">UPS Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                           ...
                                           <center> <table class="datatable table table-striped" cellspacing="0" width="100%" id="table_lista_tramites"> </center>
                                            <thead>
                                                <tr style="background-color:#D50000">
                                                        ...
                                                        <th><center>Voltaje(Entrada)</center></th>
                                                        <th><center>Voltaje(Salida)<center></th>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['entrada'].'</a></td>
                                                             <td width=200px><center>'.$info['salida'].'</a></td>
