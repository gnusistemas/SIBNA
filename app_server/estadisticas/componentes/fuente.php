<?php 
    ...
    $sql = pg_query("select * from fuente where estado= 'disponible';");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Fuente(s) de Poder(s) Disponible(s)</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                                            ...
                                            <tbody>
                                                <?php
                                                     ...
                                                     echo '<tr>
                                                             ...
                                                             <td width=200px><center>'.$info['pin'].'</center></th>
