<?php 
    ...
    $sql = pg_query("select serial,fabricante,modelo,capacidad,tipo,estado
from discoduro 
where 
tipo=(select socketdd from tarjeta where fabricante='$fab' and modelo='$mod') ");
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Discos Duros Compatibles con la tarjeta <span style="color:#2196F3"><?php echo "$fab";?></span> modelo <span style="color:#2196F3"><?php echo "$mod";?></span> </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
