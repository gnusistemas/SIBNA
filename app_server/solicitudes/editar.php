...
$sql = pg_query(" SELECT * FROM solicitud where id= '$id' and estado='pendiente'"); 
                            ...
                            <div class="card card-success">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Editar Solicitud</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="app_server/solicitudes/phpeditar.php" method="post">
                                        <div class="form-group">
                                            <label for="unidad">Unidad</label> <font color="red">*</font>
                                            <input type="text" class="form-control" name="unidad" readonly id="Unidad" placeholder="<?php echo $row['unidad'];?>" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="encargado" readonly id="Encargado" placeholder="<?php echo $row['encargado'];?>" required="">
                                        </div>
                                        <div class="form-group"> 
                                        ...
                                        <input type="hidden" class="form-control" name="unidad"  value="<?php echo $row['unidad'];?>">
                                        <input type="hidden" class="form-control" name="encargado"  value="<?php echo $row['encargado'];?>">
                                        <input type="hidden" class="form-control" name="id"  value="<?php echo $id;?>">
                                        <button  class="btn btn-success">Guardar</button>
                                        &nbsp;&nbsp;<a href="?page=ver_solicitudes"><button type="button" class="btn">Cancelar</button></a>
