                            ...
                            <div class="card card-info">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Regulador</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="app_server/biennacional/registrar/registraphp/regregulador.php" method="post">
                                       ...
                                       <div class="form-group">
                                            <label for="watts">Watts</label> <font color="red">*</font>
                                        ...
                                        <div class="form-group"> 
                                           <label for="salida">Salidas de corriente</label> <font color="red">*</font>
                                        ...
                                        <input type="hidden" class="form-control" name="nombre"  value="Regulador">
