 ...
 <div class="col-xs-3">
                        ...
                        <div class="col-xs-6">
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <form action="app_server/biennacional/registrar/registraphp/regups.php" method="post">
                                        ...
                                        <select class="form-control" name="fabricante" id="fabricante" required="">
                                              <option value=""></option>
                                                ...
                                                <option value="Losys">LogiSys</option>
                                                <option value="Seasoni">SeaSonic</option>
                                        ...
                                        <div class="form-group">
                                            <label for="entrada">voltaje entrada</label> <font color="red">*</font>
                                        <select class="form-control" name="entrada" id="entrada" required="">
                                                <option value=""></option>
                                        ...
                                        <select/>      
                                         ...
                                         <div class="form-group">
                                            <label for="salida">voltaje salida</label> <font color="red">*</font>
                                        <select class="form-control" name="salida" id="salida" required="">
                                                <option value=""></option>
                                                <option value="12v18w">12V-18W</option>
                                                <option value="12v30w">12V-30W</option>     
                                        <select/>      
                                        </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="nombre"  value="UPS">
