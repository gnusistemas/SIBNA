                            ...
                            <div class="card card-info">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Tarjeta De Vídeo</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="app_server/biennacional/registrar/registraphp/regtdv.php" method="post">
                                        ...
                                        <div class="form-group"> 
                                           <label for="puerto">Puertos HDMI</label> <font color="red">*</font>
                                          ...
                                          <div class="form-group"> 
                                           <label for="display">Display Port</label> <font color="red">*</font>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <input type="hidden" class="form-control" name="estado"  value="disponible">
                                          <input type="hidden" class="form-control" name="nombre"  value="Tarjeta de Video">
