        ...
        <div class="login-box">
            <div>
                <div class="login-form row">
                    ...
                    <img src="img/logo3.jpg" align= "left" width="100%">
                    <div class="col-sm-12">
                        <div class="login-body">
                              ...
                              ?>
                                 <div class="alert fresh-color alert-danger"><strong> Datos Incorrectos !</strong></div>
                            <?php
                                 }
                             ?>
                        ...
                        <div class="login-footer">
                            <span class="text-right"><a href="#" class="color-white">Datos Incorrectos</a></span>
                        </div>
                    </div>
                </div>
            </div>
